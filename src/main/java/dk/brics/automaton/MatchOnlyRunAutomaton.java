...
public class MatchOnlyRunAutomaton implements Serializable {
	...
	public MatchOnlyRunAutomaton(final dk.brics.automaton.Automaton a) {
		this(a, true);
	}

	public MatchOnlyRunAutomaton(dk.brics.automaton.Automaton a, final boolean tableize) {
	...
	private static dk.brics.automaton.Automaton addWildcard(final dk.brics.automaton.Automaton automaton) {
